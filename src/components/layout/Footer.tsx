        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 mb-16 lg:mb-20">
          ...
          >
            ...
            <h2 className="text-2xl md:text-4xl lg:text-5xl font-black text-[var(--foreground)] tracking-tighter uppercase leading-[1.2]">
              Architecting the <span className="text-[var(--accent)]">Future</span> <br /> through Web Development
            </h2>
          </motion.div>
        ...
        >
          <div className="flex flex-col gap-4 md:gap-6">
            ...
            <div className="flex flex-col gap-3 text-[var(--gray-muted)] text-xs md:text-sm font-medium uppercase tracking-widest">
              <Link href="/" className="hover:text-[var(--foreground)] transition-colors hover:translate-x-1 inline-block">
                Home
              </Link>
              <Link href="#about" className="hover:text-[var(--foreground)] transition-colors hover:translate-x-1 inline-block">
                About
              </Link>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4 md:gap-6">
            ...
            <div className="flex flex-col gap-3 text-[var(--gray-muted)] text-xs md:text-sm font-medium uppercase tracking-widest">
              <Link href="#projects" className="hover:text-[var(--foreground)] transition-colors hover:translate-x-1 inline-block">
                Selected Work
              </Link>
            </div>
          </div>
